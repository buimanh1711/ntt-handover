      ...
      <div className="main__info-container">
        <div className="image__library-wrapper">
          <div className="main__image">
            <Image width={"100%"} src={data.thumbnail_url} />
          </div>
        ...
        <div className="info-wrapper">
          ...
          <div className="info-rating">
            {avgStar && <Rate allowHalf value={avgStar} disabled />}
            <span
              style={{
                marginLeft: 8,
                paddingLeft: 8,
          ...
          <div className="info-field brand">
            <span className="info-title brand">Thương hiệu:</span>
            <span className="info-value brand">
