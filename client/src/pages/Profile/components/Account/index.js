...
import { fullnameReg, moreThan2Words } from "../../../../utils/validations";
          ...
          <div className="account__left">
            ...
            <div className="account__left-form">
              ...
              >
                ...
                <Form.Item {...buttonItemLayout} label="submit">
          ...
          <div className="account__right">
            <div className="update-list">
              ...
              <UpdateItem
                ...
                btnContent="Cập nhật"
                component={<PhoneUpdate onSubmit={submit} />}
              />
              <UpdateItem
                icon={<MailOutlined />}
                title="Địa chỉ email"
                ...
                btnContent="Cập nhật"
                component={<MailUpdate onSubmit={submit} />}
              />
              <UpdateItem
                ...
                component={<AddressUpdate onSubmit={submit} />}
              />
            </div>
            {/* <div className="update-list">
              <div className="account-heading">
              ...
              <UpdateItem
                ...
                btnContent="Cập nhật"
                component={<PasswordUpdate onSubmit={submit} />}
              />
            </div> */}
          </div>
        </>
