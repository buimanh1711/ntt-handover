...
const supportCustomerList = [
  { id: 1, link: " 1900-6035 ", hotline: true },
  ...
  { id: 9, security: "Hỗ trợ khách hàng: ", link: "hotro@tiki.vn" },
  { id: 10, security: "Báo lỗi bảo mật: ", link: "security@tiki.vn" },
];

const aboutUsList = [
  { id: 1, link: "Giới thiệu Tiki" },
  ...
  { id: 7, link: "Giới thiệu Tiki Xu" },
  { id: 8, link: "Tiếp thị liên kết cùng Tiki" },
...
const socialsList = [
  { id: 1, icon: "/svg/facebook-footer.svg" },
          ...
          <div className="footer_main__block">
            ...
            <div className="socials_list">
              {socialsList.map((socialItem) => {
                return (
                  <Link to="#" className="social_item" key={socialItem.id}>
